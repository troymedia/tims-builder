 ...
 * of this value object you may modify the generated sub-class of this class - IncorrectFeedback.as.
 */
...
[ExcludeClass]
public class _Super_IncorrectFeedback extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _IncorrectFeedbackEntityMetadata;
     ...
     * properties
     */
    private var _internal_image : ArrayCollection;
    model_internal var _internal_image_leaf:valueObjects.Image;
    ...
    public function _Super_IncorrectFeedback()
    {
        _model = new _IncorrectFeedbackEntityMetadata(this);
    ...
    public function get image() : ArrayCollection
    {
    ...
    {
        var oldValue:ArrayCollection = _internal_image;
        if (oldValue !== value)
        {
            ...
            {
                _internal_image = new ArrayCollection(value);
            }
            else if (value == null)
            {
            ...
            {
                throw new Error("value of image must be a collection");
            }
    ...
    model_internal function setterListenerImage(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerImage);
            }
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _IncorrectFeedbackEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _IncorrectFeedbackEntityMetadata) : void
    {
        var oldValue : _IncorrectFeedbackEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfImage : ArrayCollection;
